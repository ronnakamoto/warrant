...
pnpm --filter @warrant/agent cli -- bind-root --name alice --wallet 0x... --tier 2 --local
...
- `bind-root` generates a fresh `humanTag` + `contextHash` (nullifier inputs). Do not share static tags.
