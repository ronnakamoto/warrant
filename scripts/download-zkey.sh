#!/usr/bin/env bash
# Fetch the released warrant_final.zkey (artifacts-groth16-v3). Never commit zkeys.
set -euo pipefail
...
DEFAULT_ZKEY_URL="https://github.com/ronnakamoto/warrant/releases/download/artifacts-groth16-v3/warrant_final.zkey"
DEFAULT_VKEY_URL="https://github.com/ronnakamoto/warrant/releases/download/artifacts-groth16-v3/warrant_vkey.json"
DEFAULT_WASM_URL="https://github.com/ronnakamoto/warrant/releases/download/artifacts-groth16-v3/warrant.wasm"
