...
export const DOCS_SECTIONS: DocsSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        kind: "p",
        text: "Packages: `@ronnakamoto/warrant-core` (domain, hashes, prove/verify — no HTTP), `@ronnakamoto/warrant-x402` (shop factory + `warrantHono`), `@ronnakamoto/warrant` (`pnpm dlx` ready / act). Do not call prove from a bot.",
      },
    ],
  },
  {
