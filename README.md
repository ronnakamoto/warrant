...
**Console:** [https://warrant-beta.vercel.app](https://warrant-beta.vercel.app) — Authorize, Copy (or fetch [`/skill.md`](https://warrant-beta.vercel.app/skill.md)), fire. The skill is the paragraph. Clone is optional local prove. Base Sepolia + Hedera testnet.
...
The agent CLI is `@ronnakamoto/warrant`. A bot on this machine runs:

```bash
pnpm dlx @ronnakamoto/warrant ready
WARRANT_BEARER='<the bearer from Copy>' pnpm dlx @ronnakamoto/warrant act --url https://warrant-beta.vercel.app/api/agent/memo --body '{"text":"hi"}'
```
